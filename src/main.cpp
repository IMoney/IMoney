...
uint256 hashGenesisBlock("0x27edf673cadee3ba6d26435a82e9aae777d92a02ee50e239adb6c19ee0182bf8");
...
const string strMessageMagic = "IMoney Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // IMoney: 1 days
static const int64 nTargetSpacing = 120; // IMoney: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal imoney miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IMoney", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc2c827121f6f604cad91be533e9a9a3ea12164df4c95e514182398455fd015da");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Metro News Calgary 17/07/2013 Calgary’s historic Simmons Building will become a ‘culinary destination’";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1374132631; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 248979;

        if (fTestNet)
        {
            block.nTime    = 1374108979;
            block.nNonce   = 850580;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x035c1cbc8d3023413dc9eec6e7a7879b73d33c7cbdbbc2ae01f8717f447f86e1"));
